...
def evaluate_box_proposals(
    predictions, dataset, id_to_img_map, img_info, thresholds=None, area="all", limit=None
):
    ...
    for image_id, prediction in enumerate(predictions):
        original_id = id_to_img_map[image_id]

        image_width, image_height = img_info[image_id]["width"], img_info[image_id]["height"]
        ...
        inds = prediction.get_field("objectness").float().sort(descending=True)[1]
