...
from maskrcnn_benchmark.modeling.roi_heads.relation_head.classifier import DotProductClassifier
from maskrcnn_benchmark.modeling.roi_heads.relation_head.utils_relation import (
    obj_prediction_nms,
)
