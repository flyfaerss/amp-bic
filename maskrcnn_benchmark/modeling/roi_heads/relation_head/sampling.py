...
def make_roi_relation_samp_processor(cfg):
    samp_processor = RelationSampling(
        ...
        cfg.MODEL.ROI_RELATION_HEAD.NUM_SAMPLE_PER_GT_REL, # 4
        cfg.MODEL.ROI_RELATION_HEAD.BATCH_SIZE_PER_IMAGE, # 1000
        cfg.MODEL.ROI_RELATION_HEAD.POSITIVE_FRACTION, # 0.25
        cfg.MODEL.ROI_RELATION_HEAD.MAX_PROPOSAL_PAIR, # 4096
        cfg.MODEL.ROI_RELATION_HEAD.USE_GT_BOX, # true
        cfg.TEST.RELATION.REQUIRE_OVERLAP, # false
    )
