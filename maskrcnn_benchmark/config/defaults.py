...
_C.MODEL.ROI_RELATION_HEAD.PREDICTOR = "PISAPredictor"
...
_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE = CN()

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.GRAPH_HIDDEN_DIM = 512 # the hidden dimension of graph model

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.MESSAGE_PROPOGATION_ITERATION_NUM = 4

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.MESSAGE_PASSING_UNIT_NUM = 2

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.FREQUENCY_ADAPTION_LAYER_NUM = 2

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.SELF_FEATURE_PROPOTION = 0.3

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.MP_VALID_PAIRS_NUM = 128 # graph will only message passing on edges filtered by the rel pn structure

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.RELNESS_MP_WEIGHTING = True # the mp will take the top 150 relatedness score for mp

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.PRETRAIN_MODE = False

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.RELATION_CONFIDENCE_AWARE = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.LEARNABLE_SCALING_WEIGHT = (3.12, 0.06)  # (alpha, beta)

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.IS_USE_INFORMATIVE = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.INFORMATIVE_WEIGHT = 0.5

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_CONTRAST_LOSS = False

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_ADAPTIVE_CONFIDENCE = False

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.TRANS_LOSS = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_EMBED = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_INIT_FREQUENCY = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_RELNESS_LOSS = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_INFORMATIVE_LOSS = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_INFORMATIVE_INIT = False

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_GLOVE_PROTOTYPE = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.USE_CURRICULUM = True

_C.MODEL.ROI_RELATION_HEAD.PISA_MODULE.SEPERATE_TRAINING = False
...
_C.MODEL.ROI_RELATION_HEAD.DATA_RESAMPLING_PARAM.END_COUNT = 45
...
_C.MODEL.ROI_RELATION_HEAD.DATA_RESAMPLING_METHOD = "faip" # lvis
